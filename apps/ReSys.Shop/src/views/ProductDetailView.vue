...
const { currentProduct, similarProducts, loading } = storeToRefs(productStore);
...
<template>
    <div class="container mx-auto p-4 md:p-12">
        <div v-if="loading && !currentProduct" class="flex flex-col gap-16 animate-pulse">
        ...
        <div v-else-if="currentProduct" class="flex flex-col gap-24">
            <!-- Product Section -->
            <div class="flex flex-col lg:flex-row gap-20">
                    ...
                    <div class="sticky top-28">
                        <div class="relative rounded-[3.5rem] overflow-hidden shadow-2xl bg-white aspect-[4/5] border border-gray-100 p-6">
                            <div class="w-full h-full rounded-[2.5rem] overflow-hidden bg-gray-50">
                                <img v-if="currentProduct.image_url" :src="currentProduct.image_url" :alt="currentProduct.name" class="w-full h-full object-cover" />
                ...
                <div class="w-full lg:w-1/2 flex flex-col justify-center">
                    <div class="mb-10">
                        ...
                        <h1 class="text-6xl font-black text-gray-900 leading-[1.1] mb-4 tracking-tighter">{{ currentProduct.name }}</h1>
                    ...
                    <div class="py-12">
                        ...
                        <p class="text-gray-600 leading-[1.8] text-lg whitespace-pre-line">{{ currentProduct.description }}</p>
                    </div>
            ...
            <div v-if="similarProducts.length > 0">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
                    <Card v-for="sim in similarProducts" :key="sim.id" class="overflow-hidden border-none shadow-sm hover:shadow-xl transition-all cursor-pointer group rounded-[2.5rem] bg-white border border-gray-50" @click="router.push(`/products/${sim.id}`)">
                        <template #header>
        ...
        <div v-else class="text-center py-40 bg-gray-50 rounded-[4rem] border-2 border-dashed border-gray-200">
            ...
            <h2 class="text-4xl font-black text-gray-900 mb-4 tracking-tighter">Product Not Found</h2>
