...
<template>
    <div class="p-6 max-w-4xl mx-auto">
        <div class="flex items-center gap-4 mb-8">
            <Button icon="pi pi-arrow-left" text rounded severity="secondary" @click="router.push('/Examples')" />
            <div>
                <h1 class="text-3xl font-black text-gray-900 tracking-tight">
                    {{ isEdit ? 'Edit Example' : 'Add New Example' }}
                </h1>
                <p class="text-gray-500 mt-1">
                    {{ isEdit ? 'Update existing Example information and images.' : 'Create a new item in your Example catalog.' }}
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <template #content>
                        <div class="flex flex-col gap-6 pt-2">
                            <div class="flex flex-col gap-2">
                                <label for="name" class="font-bold text-gray-700">Example Name</label>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <Textarea id="description" v-model="form.description" rows="6" class="w-full" placeholder="Provide a detailed description of the Example features..." />
                            </div>
            ...
            <div class="lg:col-span-1">
                ...
                <div class="flex flex-col gap-3">
                    <Button label="Save Changes" icon="pi pi-check" @click="saveExample" :loading="loading" class="w-full py-4 text-lg font-bold shadow-xl" />
                    <Button label="Discard Changes" severity="secondary" outlined @click="router.push('/Examples')" class="w-full" />
                </div>
            </div>
        </div>
    </div>
