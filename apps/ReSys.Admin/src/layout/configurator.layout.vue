    ...
    >
        <div class="flex flex-col gap-4">
            <div class="flex flex-col gap-2">
                <span class="text-sm text-surface-500 font-semibold">Presets</span>
                <Select v-model="preset" @change="onPresetChange" :options="presetOptions" class="w-full" />
            </div>
            <div>
                <span class="text-sm text-surface-500 font-semibold">Primary</span>
                <div class="pt-2 grid grid-cols-5 gap-2">
                    <button
