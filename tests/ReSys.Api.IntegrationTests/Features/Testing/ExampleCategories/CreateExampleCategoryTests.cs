...
public class CreateExampleCategoryTests : BaseIntegrationTest
{
    public CreateExampleCategoryTests(IntegrationTestWebAppFactory factory, ITestOutputHelper output)
        : base(factory, output)
    {
    }
