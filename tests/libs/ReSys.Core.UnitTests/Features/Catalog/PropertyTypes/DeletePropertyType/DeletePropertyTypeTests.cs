...
public class DeletePropertyTypeTests(TestDatabaseFixture fixture) : IClassFixture<TestDatabaseFixture>
{
    ...
    public async Task Handle_ValidId_ShouldDelete()
    {
        ...
        var handler = new ReSys.Core.Features.Catalog.PropertyTypes.DeletePropertyType.DeletePropertyType.Handler(fixture.Context);
        var command = new ReSys.Core.Features.Catalog.PropertyTypes.DeletePropertyType.DeletePropertyType.Command(pt.Id);
