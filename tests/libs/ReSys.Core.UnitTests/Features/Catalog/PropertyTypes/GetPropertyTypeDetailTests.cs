...
public class GetPropertyTypeDetailTests : IClassFixture<TestDatabaseFixture>
{
    ...
    public async Task Handle_Existing_ShouldReturnDetail()
    {
        ...
        var handler = new Core.Features.Admin.Catalog.PropertyTypes.GetPropertyTypeDetail.GetPropertyTypeDetail.Handler(_fixture.Context);
        var query = new Core.Features.Admin.Catalog.PropertyTypes.GetPropertyTypeDetail.GetPropertyTypeDetail.Query(
            new Core.Features.Admin.Catalog.PropertyTypes.GetPropertyTypeDetail.GetPropertyTypeDetail.Request(pt.Id));
