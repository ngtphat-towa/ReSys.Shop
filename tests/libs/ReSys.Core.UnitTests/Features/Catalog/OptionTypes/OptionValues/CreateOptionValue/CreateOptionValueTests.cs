...
namespace ReSys.Core.UnitTests.Features.Catalog.OptionTypes.OptionValues.CreateOptionValue;
...
public class CreateOptionValueTests : IClassFixture<TestDatabaseFixture>
{
    ...
    public async Task Handle_ValidRequest_ShouldCreate()
    {
        ...
        var handler = new ReSys.Core.Features.Catalog.OptionTypes.OptionValues.CreateOptionValue.CreateOptionValue.Handler(_fixture.Context);
        var request = new ReSys.Core.Features.Catalog.OptionTypes.OptionValues.CreateOptionValue.CreateOptionValue.Request 
        { 
            Name = "Cotton",
            Presentation = "Natural Cotton"
        };
        var command = new ReSys.Core.Features.Catalog.OptionTypes.OptionValues.CreateOptionValue.CreateOptionValue.Command(ot.Id, request);
    ...
    public async Task Handle_DuplicateName_ShouldReturnError()
    {
        ...
        var handler = new ReSys.Core.Features.Catalog.OptionTypes.OptionValues.CreateOptionValue.CreateOptionValue.Handler(_fixture.Context);
        var request = new ReSys.Core.Features.Catalog.OptionTypes.OptionValues.CreateOptionValue.CreateOptionValue.Request { Name = "Large" };
        var command = new ReSys.Core.Features.Catalog.OptionTypes.OptionValues.CreateOptionValue.CreateOptionValue.Command(ot.Id, request);
