...
namespace ReSys.Core.UnitTests.Features.Catalog.OptionTypes.OptionValues.UpdateOptionValuePositions;
...
public class UpdateOptionValuePositionsTests(TestDatabaseFixture fixture) : IClassFixture<TestDatabaseFixture>
{
    ...
    public async Task Handle_ValidRequest_ShouldUpdatePositions()
    {
        ...
        var handler = new ReSys.Core.Features.Catalog.OptionTypes.OptionValues.UpdateOptionValuePositions.UpdateOptionValuePositions.Handler(fixture.Context);
        var request = new ReSys.Core.Features.Catalog.OptionTypes.OptionValues.UpdateOptionValuePositions.UpdateOptionValuePositions.Request(
            new[] 
            { 
                new ReSys.Core.Features.Catalog.OptionTypes.OptionValues.UpdateOptionValuePositions.UpdateOptionValuePositions.ValuePosition(ov1.Id, 10),
                new ReSys.Core.Features.Catalog.OptionTypes.OptionValues.UpdateOptionValuePositions.UpdateOptionValuePositions.ValuePosition(ov2.Id, 20)
            });
        var command = new ReSys.Core.Features.Catalog.OptionTypes.OptionValues.UpdateOptionValuePositions.UpdateOptionValuePositions.Command(ot.Id, request);
