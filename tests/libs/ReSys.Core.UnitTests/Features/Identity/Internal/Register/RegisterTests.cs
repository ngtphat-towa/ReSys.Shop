...
namespace ReSys.Core.UnitTests.Features.Identity.Internal.Register;
...
public class RegisterTests
{
    ...
    private readonly ReSys.Core.Features.Identity.Internal.Register.Register.Handler _handler;
    ...
    public RegisterTests()
    {
        ...
        _handler = new ReSys.Core.Features.Identity.Internal.Register.Register.Handler(_userManager, _roleManager, _notificationService, _configuration);
    }
    ...
    {
        // Arrange
        var request = new ReSys.Core.Features.Identity.Internal.Register.Register.Request { Email = "test@example.com", Password = "Password123!", ConfirmPassword = "Password123!" };
        var command = new ReSys.Core.Features.Identity.Internal.Register.Register.Command(request);
    ...
    public async Task Handle_WhenNotificationFails_ShouldRollbackUserCreation()
    {
        ...
        _notificationService.SendAsync(Arg.Any<ReSys.Core.Common.Notifications.Models.NotificationMessage>(), Arg.Any<CancellationToken>())
