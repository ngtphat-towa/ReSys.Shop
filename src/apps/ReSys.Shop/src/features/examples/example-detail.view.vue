...
<template>
    <div class="container mx-auto p-4 md:p-12" :style="dynamicStyle">
        ...
        <div v-if="loading && !currentExample" class="flex flex-col gap-16 animate-pulse">
            <div class="flex flex-col lg:flex-row gap-16">
                ...
                <div class="w-full lg:w-1/2 flex flex-col gap-6 pt-8">
                    <div class="h-16 bg-surface-100 dark:bg-surface-800 rounded-2xl w-3/4"></div>
                    <div class="h-12 bg-surface-100 dark:bg-surface-800 rounded-2xl w-1/4"></div>
                    <div class="h-40 bg-surface-100 dark:bg-surface-800 rounded-2xl w-full mt-8"></div>
                </div>
            </div>
        </div>
                    ...
                    <div class="sticky top-28">
                        <div class="relative rounded-[3.5rem] overflow-hidden shadow-2xl bg-surface-0 dark:bg-surface-900 aspect-[4/5] border border-surface-100 dark:border-surface-800 p-6">
                            <div class="w-full h-full rounded-[2.5rem] overflow-hidden bg-surface-50 dark:bg-surface-800">
                                ...
                                <div v-else class="w-full h-full flex items-center justify-center text-surface-200 dark:text-surface-700">
                ...
                <div class="w-full lg:w-1/2 flex flex-col justify-center">
                    <div class="mb-10">
                        ...
                        <div class="flex items-center gap-4 mb-4">
                            ...
                            <div v-if="currentExample.hex_color" 
                                 class="w-10 h-10 rounded-2xl shadow-lg border border-surface-100 dark:border-surface-800 flex-shrink-0"
                    ...
                    <div class="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div class="p-6 bg-surface-50 dark:bg-surface-800 rounded-3xl border border-surface-100 dark:border-surface-700 flex items-center gap-5">
                            <div class="w-12 h-12 bg-surface-0 dark:bg-surface-900 rounded-2xl flex items-center justify-center shadow-sm text-primary">
