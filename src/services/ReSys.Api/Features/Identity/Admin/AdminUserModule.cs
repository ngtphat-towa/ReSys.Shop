...
using ReSys.Core.Features.Identity.Admin.Users.GetAdminUsersPagedList;
using ReSys.Core.Features.Identity.Admin.Users.GetAdminUserDetail;
using ReSys.Core.Features.Identity.Admin.Users.CreateAdminUser;
using ReSys.Core.Features.Identity.Admin.Users.UpdateAdminUser;
using ReSys.Core.Features.Identity.Admin.Users.DeleteAdminUser;
using ReSys.Core.Features.Identity.Admin.Users.AssignRoleToUser;
using ReSys.Core.Features.Identity.Admin.Users.UnassignRoleFromUser;
using ReSys.Core.Features.Identity.Admin.Users.UpdateUserStatus;
using ReSys.Core.Features.Identity.Admin.Users.AssignPermissionToUser;
using ReSys.Core.Features.Identity.Admin.Users.UnassignPermissionFromUser;
using ReSys.Core.Features.Identity.Admin.Users.GetUserPermissions;
using ReSys.Core.Features.Identity.Admin.Users.GetUserRoles;
using ReSys.Core.Features.Identity.Admin.Users.SyncUserRoles;
using ReSys.Core.Features.Identity.Admin.Users.UpdateStaffProfile;
