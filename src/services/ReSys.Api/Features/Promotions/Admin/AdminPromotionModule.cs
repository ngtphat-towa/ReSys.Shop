...
using ReSys.Core.Features.Admin.Promotions.GetPromotionsPagedList;
using ReSys.Core.Features.Admin.Promotions.GetPromotionDetail;
using ReSys.Core.Features.Admin.Promotions.CreatePromotion;
using ReSys.Core.Features.Admin.Promotions.UpdatePromotion;
using ReSys.Core.Features.Admin.Promotions.DeletePromotion;
using ReSys.Core.Features.Admin.Promotions.Rules.AddProductRule;
using ReSys.Core.Features.Admin.Promotions.Rules.AddCategoryRule;
using ReSys.Core.Features.Admin.Promotions.Rules.AddGroupRule;
using ReSys.Core.Features.Admin.Promotions.Actions.UpdateAction;
using ReSys.Core.Features.Admin.Promotions.GetPromotionStats;
using ReSys.Core.Features.Admin.Promotions.GetPromotionUsageHistory;
using ReSys.Core.Features.Admin.Promotions.ActivatePromotion;
using ReSys.Core.Features.Admin.Promotions.DeactivatePromotion;
using ReSys.Core.Features.Admin.Promotions.PreviewPromotion;
