...
using ReSys.Core.Features.Admin.Catalog.Products.Variants.CreateVariant;
using ReSys.Core.Features.Admin.Catalog.Products.Variants.DeleteVariant;
using ReSys.Core.Features.Admin.Catalog.Products.Variants.GetVariantDetail;
using ReSys.Core.Features.Admin.Catalog.Products.Variants.GetVariantSelectList;
using ReSys.Core.Features.Admin.Catalog.Products.Variants.GetVariantsPagedList;
using ReSys.Core.Features.Admin.Catalog.Products.Variants.ManageVariantOptionValues;
using ReSys.Core.Features.Admin.Catalog.Products.Variants.SetMasterVariant;
using ReSys.Core.Features.Admin.Catalog.Products.Variants.SetVariantPrice;
using ReSys.Core.Features.Admin.Catalog.Products.Variants.UpdateVariant;
using ReSys.Core.Features.Admin.Catalog.Products.Variants.DiscontinueVariant;
