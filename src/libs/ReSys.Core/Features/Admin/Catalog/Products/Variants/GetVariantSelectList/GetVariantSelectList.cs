...
using ReSys.Core.Features.Admin.Catalog.Products.Variants.Common;
using ReSys.Shared.Models.Query;
using ReSys.Shared.Models.Pages;

namespace ReSys.Core.Features.Admin.Catalog.Products.Variants.GetVariantSelectList;

public static class GetVariantSelectList
{
    ...
    public record Response : VariantSelectListItem;
