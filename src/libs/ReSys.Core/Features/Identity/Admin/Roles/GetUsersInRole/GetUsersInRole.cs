...
namespace ReSys.Core.Features.Identity.Admin.Roles.GetUsersInRole;
...
public static class GetUsersInRole
{
    ...
    public class Handler(UserManager<User> userManager, RoleManager<ReSys.Core.Domain.Identity.Roles.Role> roleManager) 
