...
public static partial class NotificationConstants
{
    public sealed record Template : Definition<UseCase>
    {
        ...
        public Formats.Enumerate TemplateFormatType { get; init; } = Formats.Enumerate.Default;
    ...
    public static readonly Dictionary<UseCase, Template> Templates = new()
    {
        [key: UseCase.SystemActiveEmail] = new Template
        {
            ...
            TemplateFormatType = Formats.Enumerate.Html,
        ...
        [key: UseCase.SystemActivePhone] = new Template
        {
            ...
            TemplateFormatType = Formats.Enumerate.Default,
        ...
        [key: UseCase.UserProfileUpdateEmail] = new Template
        {
            ...
            HtmlTemplateContent = "<html><body style='font-family: Arial, sans-serif; color: #333; background-color: #f9f9f9; padding: 20px;'><img src='[BrandLogoUrl]' alt='{SystemName} Logo' style='max-width: 150px;'><h2 style='color: #d81b60;'>Hi {UserFirstName},</h2><p>Your {SystemName} profile has been updated.</p><p>Not you? Contact us at <a href='mailto:{SupportEmail}'>{SupportEmail}</a>.</p><p style='color: #777;'>Keep shining!</p><p><a href='[InstagramUrl]'>Follow us on Instagram</a></p></body></html>",
            ParamValues =
            [
                Parameter.UserFirstName,
                Parameter.SystemName,
